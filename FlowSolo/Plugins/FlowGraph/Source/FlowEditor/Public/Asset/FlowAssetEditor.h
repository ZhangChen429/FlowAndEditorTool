...
class FLOWEDITOR_API
FFlowAssetEditor : public FAssetEditorToolkit, public FEditorUndoClient, public FGCObject, public FNotifyHook
{
public:
...
public:
	void InitFlowAssetWidget( UObject* ObjectToEdit);
protected:
